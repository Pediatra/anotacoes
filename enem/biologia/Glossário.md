...
Uma **solução hipertônica** possui uma maior concentração de **solutos**. Já uma **solução hipotônica** possui uma menor concentração de **solutos**.
